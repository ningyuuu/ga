...
class TestFindX(unittest.TestCase):
    ...
    def test_findX_with_only_one_element(self):
        # nLower=1, nUpper=1 guarantees a single-element array
        x = self.findX_instance.start(1234, 1, 1)
    ...
    def test_findX_not_in_array(self):
        ...
        # x + 1 is not in the array
        index, calls = findXinA(x + 1, self.findX_instance)
